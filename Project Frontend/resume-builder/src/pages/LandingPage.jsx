...
<section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="text-center mb-16">
      ...
      <p className="text-xl text-gray-600 max-w-3xl mx-auto">
        Designed to help you create professional resumes faster and smarter.
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
      ...
      <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
        ...
        <p className="text-gray-600">
          Fill in your personal information, skills, education, and experience using our easy-to-use forms.
        </p>
      </div>

      <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
        <div className="text-5xl mb-4">🎨</div>
        <h3 className="text-2xl font-semibold mb-3">Choose a Template</h3>
        <p className="text-gray-600">
          Select from modern, professional templates designed to pass ATS systems.
        </p>
      </div>

      <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
        <div className="text-5xl mb-4">📄</div>
        <h3 className="text-2xl font-semibold mb-3">Download & Share</h3>
        <p className="text-gray-600">
          Export your resume as PDF and start applying for jobs instantly.
        </p>
      </div>
